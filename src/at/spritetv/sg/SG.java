...
import at.spritetv.sg.commands.Build;
import at.spritetv.sg.commands.SetDMSpecLobby;
import at.spritetv.sg.commands.SetDmSpawn;
import at.spritetv.sg.commands.SetLobby;
import at.spritetv.sg.commands.SetSpawn1;
import at.spritetv.sg.commands.SetSpawn2;
import at.spritetv.sg.commands.SetSpawn3;
import at.spritetv.sg.commands.SetSpecLobby;
import at.spritetv.sg.commands.SetTop;
import at.spritetv.sg.commands.Start;
import at.spritetv.sg.commands.Stats;
import at.spritetv.sg.listeners.BlockBP;
import at.spritetv.sg.listeners.ChestListener;
import at.spritetv.sg.listeners.Compass;
import at.spritetv.sg.listeners.DeathListener;
import at.spritetv.sg.listeners.ItemVote;
import at.spritetv.sg.listeners.JoinListener;
import at.spritetv.sg.listeners.Listeners;
import at.spritetv.sg.listeners.NoMove;
import at.spritetv.sg.listeners.PingListener;
import at.spritetv.sg.listeners.QuitListener;
import at.spritetv.sg.listeners.SetSignTop;
import at.spritetv.sg.listeners.TnT;
...
public class SG extends JavaPlugin{
	...
	public void onEnable() {
		...
		logger.info("[SurvivalGames] Plugin by SpriteTV Skype: xxIHackIxx");
		Bukkit.getConsoleSender().sendMessage("[SurvivalGames] Plugin by SpriteTV Skype: xxIHackIxx");
	...
	public void loadMySQL() {
		...
		mysql = new MySQL("localhost", "root", "database", "password");
